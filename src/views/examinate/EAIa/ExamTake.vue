...
const examObj = examEAIA();

// 現在ページの設問
const questions = ref<eaiaQuestion[]>([]);
...
const loadAnswer = async () => {
  // 保存済み回答を取得
  const res = await ExamEAIAApiService.getEAIA({
    params: k,
    testparts_id,
    page: page.value,
  });
