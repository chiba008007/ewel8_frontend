...
class ExamBAJ4ApiService {
  async getBAJ4(data: object) {
    // 403をExamTake.vueのcatchへ渡す
    return httpAuth.post("/api/exam/getBAJ4", data);
  }
  setBAJ4(data: object) {
    return httpAuth.post("/api/exam/setBAJ4", data);
  }
  editBAJ4(data: object) {
    return httpAuth.post("/api/exam/editBAJ4", data);
  }
...
export default new ExamBAJ4ApiService();
