...
import { startExam } from "@/services/examBaj4Service";
import { recordExamLog } from "@/services/examLogService";
import { ExamBasePayload } from "@/types/examBaj4";
import ExamApiService from "@/services/ExamApiService";
import type { LocationQueryValue } from "vue-router";

export const useExamBaj4 = () => {
  ...
  const onStart = async (
    ...
    await router.replace({
      name: payload.page == 5 ? "ExamBaj4TakeFin" : "examBaj4Take",
      params: {
